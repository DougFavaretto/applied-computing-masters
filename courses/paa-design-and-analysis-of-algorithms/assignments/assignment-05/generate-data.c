...
int main (int argc, char *argv[]) {
    ...
    mkdir("inputs", 0755);
    create_dataset("inputs/test_random_data.txt", random_data, size, seed, 0);
    create_dataset("inputs/test_sorted_asc_data.txt", sorted_asc_data, size, seed, 1);
    create_dataset("inputs/test_sorted_desc_data.txt", sorted_desc_data, size, seed, 2);
